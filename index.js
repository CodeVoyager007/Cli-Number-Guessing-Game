...
const mainGameLoop = async () => {
    for (let index = 1; index <= attempts; index++) {
        ...
        if (answerUser.guessedNumber === randomNumber) {
            console.log(chalk.green("Congratulations! You've guessed the correct number!"));
        ...
        if (attempts === index) {
            ...
            console.log(chalk.blue(`The correct number was ${randomNumber}. Better luck next time!`));
            restartGame(); // Ask if the user wants to play again
        }
    }
};
